...
namespace Regras
{
    public static class DerCreator
    {
        /// <summary>
        ...
        {
            Util.CL_Files.WriteOnTheLog("Document.Gerar", Global.TipoLog.DETALHADO);
            try
            {
                if (!Util.Funcoes.ExisteArquivoAtualizarDER())
                {
                    return true;
                }

                Util.Funcoes.ExcluiArquivoAtualizarDER();
